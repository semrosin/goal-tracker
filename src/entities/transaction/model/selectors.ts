...
export const calculateBalance = (goalId: string, transactions: Transaction[]): number =>
  transactions
...
export const selectTransactionsForGoal = (transactions: Transaction[], goalId: string): Transaction[] =>
